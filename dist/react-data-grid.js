...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleTextEditor = function (_EditorBase) {
	  ...
	  SimpleTextEditor.prototype.render = function render() {
	    return React.createElement('input', { ref: 'input', id:this.props.column.key, type: 'text', onBlur: this.props.onBlur, className: 'form-control', defaultValue: this.props.value });
	  };
